...
import { AppBar, Toolbar, IconButton, Box, Drawer, List, ListItem, Tooltip } from '@mui/material';
    ...
    <>
      ...
      >
        <Toolbar style={{ display: 'flex', justifyContent: 'space-between' }}>
          {/* Logo */}
          <Box sx={{ fontFamily: '"Roboto","Helvetica","Arial",sans-serif', fontWeight: 600, color: 'white', fontSize: '1.2rem'  }}>
            My Portfolio
          </Box>
